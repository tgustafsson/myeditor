...
void CursesView::update(const std::vector<shared_ptr<AttributedString>> rows, shared_ptr<Mode> mode, size_t view_col)
{
	auto view = rows;
	auto attributed_view = mode->syntax_highlight(view);
	int y = m_win_y;
