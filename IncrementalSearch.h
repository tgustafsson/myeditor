...
public:
   ...
   KeyCord::command_return_t my_incremental_search(std::shared_ptr<Model> model, std::shared_ptr<View> view, std::shared_ptr<Control> control, std::shared_ptr<Control> incremental_search_control, std::shared_ptr<Model> incremental_search_model, std::shared_ptr<View> incremental_search_view, std::shared_ptr<TabsMode> tabs_mode);
